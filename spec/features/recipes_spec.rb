...
RSpec.describe 'Recipe page', type: :system do
  before do
    ...
    @recipe1 = Recipe.create(name: 'Recipe 1', description: 'Description 1', preparation_time: 0, cooking_time: 0, user: @user)
    @recipe2 = Recipe.create(name: 'Recipe 2', description: 'Description 2', preparation_time: 0, cooking_time: 0, user: @user)
